...
- Alibaba Cloud Linux
  ...
  Alibaba Cloud Linux是阿里云研发的Linux操作系统，旨在为ECS实例上的应用程序提供更加安全、稳定、高性能的运行环境
...
- Red Hat系列
  ...
  | :------- | :--------- | :------- | :------- | :----------------------------------------------------------- | :------------------------------------------------------- |
  | CentOS   | rpm包      | yum      | 免费使用 | 稳定，但补丁更新速度慢于Red Hat。支持在线升级，可即时更新系统。 | CentOS是Red Hat的开源版本。两者rpm包通用。两者命令通用。 |
...
- Debian系列
  ...
  | Ubuntu   |            | apt-get  | 系统配置更人性化。软件的更新更为激进。新手友好度更高，易用性更好，更容易上手。 |                                                              |
